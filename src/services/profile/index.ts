...
export const updateProfileWork = async (token: string, data: { worksAt: string }) => {
  try {
    const res = await fetch(`${apiBaseUrl}/profile/work`, {
      method: 'PATCH',
      headers: {
...
export const updateProfileLocation = async (token: string, data: { location: string }) => {
  try {
    const res = await fetch(`${apiBaseUrl}/profile/location`, {
      method: 'PATCH',
      headers: {
...
export const updateProfileLanguage = async (token: string, data: { languages: string[] }) => {
  try {
    const res = await fetch(`${apiBaseUrl}/profile/language`, {
      method: 'PATCH',
      headers: {
...
export const updateProfileBio = async (token: string, data: { bio: string }) => {
  try {
    const res = await fetch(`${apiBaseUrl}/profile/bio`, {
      method: 'PATCH',
      headers: {
...
export const updateProfileAvatar = async (token: string, formData: FormData) => {
  try {
    const res = await fetch(`${apiBaseUrl}/profile/avatar`, {
      method: 'PATCH',
      headers: {
