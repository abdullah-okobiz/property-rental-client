// contexts/ListingStepContext.tsx
'use client';
...
const ListingStepContext = createContext<ListingStepContextType | undefined>(undefined);

export const useListingStepContext = () => {
  const context = useContext(ListingStepContext);
  if (!context) {
    throw new Error('useListingStepContext must be used within a ListingStepProvider');
  }
  return context;
};
